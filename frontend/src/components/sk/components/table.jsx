...
export function EventTable({headers, body}) {
    return (
        <section className="container flex flex-col my-6 h-full px-4 mx-auto">
                                    ...
                                    <tr>
                                        {
                                            headers?.map((header, id) => (
                                                <th key={id} scope="col" className="capitalize py-3.5 px-4 text-sm font-normal text-left rtl:text-right text-gray-500 dark:text-gray-400">
                                                    {
                                                        id == 0 ?
            ...
            <div class="flex items-center justify-between mt-6">
                <a href="#" class="flex items-center px-5 py-2 text-sm text-gray-700 capitalize transition-colors duration-200 bg-white border rounded-md gap-x-2 hover:bg-gray-100 dark:bg-gray-900 dark:text-gray-200 dark:border-gray-700 dark:hover:bg-gray-700">
...
export function PaymentTable({headers, body}) {
    return (
        <section className="container flex flex-col my-6 h-full px-4 mx-auto">
            <div className="flex flex-col flex-auto">
                <div className="-mx-4 -my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
...
export function VenueTable({headers, body}) {
    return (
        <section className="container flex flex-col my-6 h-full px-4 mx-auto">
            <div className="flex flex-col flex-auto">
                <div className="-mx-4 -my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
