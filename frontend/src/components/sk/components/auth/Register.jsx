                ...
                <AnimatePresence>
                    {
                        ...
                        <motion.div className="relative flex items-center mt-8"
                                initial={{ y: '4.2rem' }}
                                animate={{ y: 0 }}
                                exit={{ y: '4.2rem' }}
                        ...
                        >
                            ...
                            <input name='username' type="text" className="block w-full py-3 text-gray-700 bg-white border rounded-lg px-11 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-600 focus:border-orange-700 dark:focus:border-orange-600 focus:ring-orange-600 focus:outline-none focus:ring focus:ring-opacity-40" placeholder="Username" required />
                        </motion.div>
                    }
                </AnimatePresence>
