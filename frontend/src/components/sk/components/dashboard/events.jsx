        ...
        <div className='flex flex-auto bg-black bg-opacity-50'>
            ...
            <div className='flex flex-col w-full items-center m-5 text-white'>
                <div className='mb-8 px-2 h-16 w-full flex items-center justify-end'>
                    <button onClick={() => setOpen(true)} className="py-2 px-6 transition-all duration-300 flex justify-center items-center space-x-3 capitalize text-xl rounded-lg border-2 border-primary bg-transparent hover:text-black hover:bg-primary-hover text-primary">
